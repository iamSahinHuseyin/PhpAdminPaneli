...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <?php
       //Değer gelip- gelmediğini kontrol etmek.
	   if($_POST)
	   {
      //Telefon, mail, adres, fax değerlerimiz boş değilse;
        ...
        //Filtreleme işlemi.
			  ...
			  //Güncellemede bir sıkıntı olmadıysa kullanıcıya mesaj vermek.
			   ...
			   else//İşlem sırasında bir sorun olduğunda kullanıcıya mesaj vermek.
			   {
				    ?>
		   ...
		   else//Eğer kullanıcı textbox'ları boş bıraktıysa kullanıcıya mesaj vermek.
		   {
			   ?>
