<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php
	  if($_POST)//Bir değer gelip gelmediğini kontrol etmek
	  {
      //Vt sınıfı içerisinde modul ekle fonksiyonunu çağırmak.
		  $calistir=$VT->ModulEkle();
      //
		  if($calistir!=false)
		  {
        //Modul yok ise yeniden oluşaktır.
			  echo '<div class="alert alert-success">Modülünüz başarıyla eklenmiştir.</div>';
			  ?>
            <meta http-equiv="refresh" content="2;url=<?=SITE?>">
            <?php
		  }
      //Tablo ile ilgili hata mesajları vermek.
		  else
		  {
