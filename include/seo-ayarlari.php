...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
	   ...
	   if($_POST)
	   {
      //Baslık, anahtar, descriptin alanlarında bir değer varsa
        ...
        //Filtreleme işlemi
         ...
         //Sql sorgumuz olan update (güncelleme işlemi)		   
			  ...
			  //Veri güncellemede bir sıkıntı yoksa urlyi yenileme işlemi
			   ...
			   else//Bir sıkıntı varsa kullanıcıya hata mesajı verme
			   {
				    ?>
		   ...
		   else//Boş bir alan varsa kullanıcıya mesaj verme
		   {
			   ?>
